...
const displayCSE = document.getElementById("cse");
...
displayCSE.addEventListener("click", filterCSE);

displayWDD.addEventListener("click", filterWDD);

document.onload(filterAll());
